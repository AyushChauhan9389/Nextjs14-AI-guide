...
const Pageult = () => {
  return (
    <div className="w-full md:h-screen h-fit mt-10">
        ...
        <div className="mt-10 space-y-5">
          <div className="md:flex md:flex-row">
            <div className="md:w-1/2 md:space-y-7 w-full">
              <h1 className=" md:text-3xl text-xl md:font-bold font-semibold bg-[#dcffa0b3] w-fit text-center">
                The most optimal
              </h1>
              <p className="text-[#616161] md:w-4/5 w-full m-0 mt-3 text-sm md:text-lg">
            ...
            <div className="md:w-1/2 md:mt-0 w-3/4 m-auto">
              <img
                ...
                className="  md:w-64 md:m-auto w-0" alt="Description of image"
              />
            </div>
          </div>
          ...
          <div className="md:flex md:flex-row">
            ...
            <div className="md:w-1/2 space-y-7 w-full">
              <h1 className=" md:text-3xl text-xl md:font-bold font-semibold bg-[#dcffa0b3] w-fit">
                Get Inspired
              </h1>
              <p className="text-[#616161] md:w-4/5 w-full m-0 mt-3 text-sm md:text-lg">
        ...
        <div className=" md:w-1/4 md:space-y-3 w-[90%] rounded-md md:m-0 m-auto border md:border-none px-4 py-2 md:p-0 md:mb-0 mb-3">
          <div className="flex flex-row space-x-4">
            <img
              ...
              className="md:w-20 w-12" alt="Description of image"
            />
      ...
      <div className="md:mt-36 mt-20">
        ...
        <div className="md:flex md:flex-row w-[90%] m-auto justify-evenly mt-14">
          <div className="border-2 rounded-lg md:w-[30%] w-full p-6 h-64 md:mt-0">
            <div className="flex flex-row mb-5">
              <img
                src="https://tripplanner.ai/_next/image?url=%2Flanding%2Fimages%2Freviews%2Fdavid_jordan.webp&w=128&q=75"
                className=" w-12 rounded-full" alt="Description of image"
              />
              <div className=" ml-3">
            ...
            <div className=" space-y-2">
              <img className="w-[30%]" src="star.jpg"  alt="Description of image"/>
          ...
          <div className="border rounded-lg md:w-[30%] w-full p-6 md:mt-16 h-64 mt-6">
            <div className="flex flex-row mb-5">
              <img
          ...
          <div className="border-2 rounded-lg md:w-[30%] w-full p-6 h-64 md:mt-0 mt-6">
            <div className="flex flex-row mb-5">
              <img
      ...
      <div className=" w-[90%] m-auto mt-32 md:space-y-10">
        ...
        <div>
          <div className="md:flex md:flex-row">
            <div className="md:w-[45%] w-3/4 md:h-80 border m-auto overflow-hidden relative group rounded-3xl md:mt-0 mt-5">
              <img
                className="relative z-10 hover:scale-110 duration-500 "
                src="taj.jpg" alt="Description of image"
              />
            </div>

            <div className="md:w-[45%] w-3/4 md:h-fit border m-auto overflow-hidden relative group shadow-inn rounded-3xl md:mt-0 mt-5">
              <img
                className="object-cover relative z-10 hover:scale-110 duration-500 "
                src="m.jpg" alt="Description of image"
              />
            </div>
          </div>

          <div className="md:flex md:flex-row">
            <div className="md:w-[45%] w-3/4 md:h-fit border m-auto overflow-hidden relative group shadow-inn rounded-3xl md:-mt-8 mt-5">
              <img
                className="object-cover relative z-10 hover:scale-110 duration-500"
                src="vertical2.jpg" alt="Description of image"
              />
            </div>
            <div className="md:w-[45%] w-3/4 md:h-80 h-48 border  m-auto overflow-hidden relative group shadow-inn rounded-3xl md:mt-16 mt-5">
              <img
                className="relative z-10 hover:scale-110 duration-500 "
                src="p.jpg" alt="Description of image"
              />
            </div>
          </div>
        </div>
